"""
Example: Maximized Window Chart
Opens chart in maximized window (fills screen but keeps window controls)
"""
...
def main():
    print("=" * 70)
    print("Maximized Window Chart Demo")
    print("=" * 70)
    print("\n🖥️  Opening chart in MAXIMIZED window...")
    print("   • Window fills screen but keeps title bar")
    print("   • You can minimize, close, resize normally")
    print("   • Crosshair works perfectly")
    print("=" * 70)
    
    # Create chart in MAXIMIZED mode
    chart = Chart(
        title="Maximized Trading Chart - BTC/USD",
        background_color="#1e1e1e",  # Dark theme
        maximized=True  # ⭐ THIS MAXIMIZES THE WINDOW
    )
    ...
    print("   Window controls (close, minimize, resize) are still available!")
    
    # Render chart maximized
    chart.render()
